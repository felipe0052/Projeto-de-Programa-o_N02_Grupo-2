      ...
      <>
        ...
        <main className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-2xl font-bold mb-4">Conteúdo de aulas indisponível</h1>
            <p className="text-muted-foreground mb-8">A API atual não fornece módulos/aulas para exibição</p>
            <Link href="/courses">
      ...
      <main className="min-h-screen bg-background">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold mb-4">Curso</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              <div className="bg-card border border-border rounded-lg overflow-hidden mb-8">
                <div className="w-full h-96 bg-muted flex items-center justify-center text-sm">
                  Conteúdo de vídeo indisponível
                </div>
              </div>
              ...
              <div className="bg-card border border-border rounded-lg p-6 mb-8">
                <div className="mb-6">
                  ...
                  <p className="text-muted-foreground">Sem detalhes disponíveis</p>
                </div>
